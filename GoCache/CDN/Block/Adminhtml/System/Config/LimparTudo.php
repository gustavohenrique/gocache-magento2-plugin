...
class LimparTudo extends \Magento\Config\Block\System\Config\Form\Field
{
    protected function _prepareLayout()
    {
        parent::_prepareLayout();
        $this->setTemplate('GoCache_CDN::system/config/limpartudo.phtml');
        return $this;
    }
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $this->addData(
            [
                ...
                'ajax_url' => $this->_urlBuilder->getUrl('gocache/full_system_config/limpartudo'),
